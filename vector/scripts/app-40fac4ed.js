 ...
 *
 */
function(){"use strict";function e(e,t,i,a){function r(){i.get(t.properties.protocol+"://"+t.properties.host+":"+t.properties.port+"/pmapi/"+t.properties.context+"/_fetch?names=generic.systack").success(function(){a.to("alert-sysstack-success").success="generic.systack requested!",e.info("generic.systack requested")}).error(function(){a.to("alert-sysstack-error").error="failed requesting generic.systack!",e.error("failed requesting generic.systack")})}return{generate:r}}e.$inject=["$log","$rootScope","$http","flash"],angular.module("app.services").factory("FlameGraphService",e)}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function e(e,t,i,a){var r=function(){return this};return r.prototype=Object.create(e.prototype),r.prototype.init=function(){e.prototype.init.call(this),this.name=this.dataModelOptions?this.dataModelOptions.name:"metric_"+i.getGuid();var r,n=t.getOrCreateCumulativeMetric("network.interface.in.bytes"),o=t.getOrCreateCumulativeMetric("network.interface.out.bytes");r=function(){var e,t=[];return angular.forEach(n.data,function(i){a.setCurrentTime(i.previousTimestamp),i.values.length>0&&-1!==i.key.indexOf("veth")&&a.isTimeCurrent(i.previousTimestamp)&&(e=i.values[i.values.length-1],t.push({timestamp:e.x,key:i.key+" in",value:e.y/1024}))}),angular.forEach(o.data,function(i){i.values.length>0&&-1!==i.key.indexOf("veth")&&a.isTimeCurrent(i.previousTimestamp)&&(e=i.values[i.values.length-1],t.push({timestamp:e.x,key:i.key+" out",value:e.y/1024}))}),t},this.metric=t.getOrCreateDerivedMetric("container.network.interface",r),this.updateScope(this.metric.data)},r.prototype.destroy=function(){t.destroyDerivedMetric("container.network.interface"),t.destroyMetric("network.interface.in.bytes"),t.destroyMetric("network.interface.out.bytes"),e.prototype.destroy.call(this)},r}e.$inject=["WidgetDataModel","MetricListService","VectorService","ContainerMetadataService"],angular.module("app.datamodels").factory("ContainerNetworkBytesMetricDataModel",e)}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
