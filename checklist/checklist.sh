...
metrics="kernel.percpu kernel.all.load disk.dm.avactive disk.dm.total disk.dm.blktotal mem.freemem mem.phymem swap.pagesin swap.pagesout mem.vmstat.thp_collapse_alloc mem.vmstat.thp_fault_alloc mem.vmstat.thp_fault_fallback network.interface.out.bytes network.interface.in.bytes network.interface.out.drops network.interface.in.drops network.interface.out.errors network.interface.in.errors"
