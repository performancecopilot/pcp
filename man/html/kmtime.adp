...
<profile>
    <property name="name">KmTimeHelp</property>
    <property name="title">KmTime Help</property>
    <property name="applicationicon">../../images/kmtime.png</property>
    <property name="startpage">index.html</property>
    <property name="assistantdocs">../../../doc/html</property>
</profile>

<DCF ref="index.html" icon="../../images/kmtime.png" title="KmTime">
    <section ref="./manual.html" title="PCP Time Controls">
