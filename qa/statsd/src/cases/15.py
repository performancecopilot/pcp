...
command_to_execute = [
    'echo "statsd.pmda.settings.duration_aggregation_type"',
    'echo "statsd.pmda.settings.parser_type"',
    'echo "statsd.pmda.settings.port"',
    'echo "statsd.pmda.settings.debug_output_filename"',
    'echo "statsd.pmda.settings.verbose"',
    'echo "statsd.pmda.settings.max_unprocessed_packets"',
    'echo "statsd.pmda.settings.max_udp_packet_size"',
    'echo "statsd.pmda.time_spent_aggregating"',
    'echo "statsd.pmda.time_spent_parsing"',
    'echo "statsd.pmda.metrics_tracked"',
    'echo "statsd.pmda.aggregated"',
    'echo "statsd.pmda.dropped"',
    'echo "statsd.pmda.parsed"',
    'echo "statsd.pmda.received"',
