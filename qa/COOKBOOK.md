...
<a id="idx+vars+pcpplatform">**$PCP_PLATFORM**</a> and
<a id="idx+vars+pcpver">**$PCP_VER**</a>
The common values for **$PCP_PLATFORM** are **linux**, **darwin**, **freebsd**, **netbsd**, **openbsd**, **solaris**. 
**$PCP_VER** is an all numeric PCP version number, e.g. 70100 for PCP 7.1.0, suitable for making relative numeric comparisons), so can be used as follows:
...
|**$PCP_PLATFORM**|See the [_localconfig_ file](#the-localconfig-file) section.|
|**$PCP_VER**|See the [_localconfig_ file](#the-localconfig-file) section.|
...
- Use [**$PCP_PLATFORM**](#idx+vars+pcpplatform) for platform-specific conditional things, including when to call [**_notrun**](#idx+funcs+notrun).
...
|[find-metric](#idx+cmds+find-metric)|[\_filter\_helgrind](#idx+funcs+filterhelgrind)|[\_prepare\_pmda](#idx+funcs+preparepmda)|[$PCP_PLATFORM](#idx+vars+pcpplatform)|
...
|[mk.qa\_hosts](#idx+cmds+mk.qahosts)|[\_filter\_pcp\_start\_distro](#idx+funcs+filterpcpstartdistro)|[\_remove\_job\_scheduler](#idx+funcs+removejobscheduler)|[$PCP_VER](#idx+vars+pcpver)|
...
|**Shell Functions**|[\_filter\_post](#idx+funcs+filterpost)|[\_set\_dsosuffix](#idx+funcs+setdsosuffix)|[check.log](#idx+files+check.log)|
|[\_all\_hostnames](#idx+funcs+allhostnames)|[\_filter\_slow\_pmie](#idx+funcs+filterslowpmie)|[\_show\_pmie\_errors](#idx+funcs+showpmieerrors)|[check.time](#idx+files+check.time)|
...
|[\_check\_agent](#idx+funcs+checkagent)|[\_find\_free\_port](#idx+funcs+findfreeport)|[\_systemctl\_status](#idx+funcs+systemctlstatus)|[qa\_hosts](#idx+files+qahosts)|
|[\_check\_core](#idx+funcs+checkcore)|[\_find\_key\_server\_modules](#idx+funcs+findkeyservermodules)|[\_triage\_pmcd](#idx+funcs+triagepmcd)|[qa\_hosts.primary](#idx+files+qahosts.primary)|
