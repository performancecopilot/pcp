...
enum {
    ...
    /* in-tree dm-vdo (kernel >= 6.9) additions */
    VDODEV_BIOS_ACKNOWLEDGED_EMPTY_FLUSH	= 167,
    VDODEV_BIOS_ACKNOWLEDGED_PARTIAL_EMPTY_FLUSH = 168,
    VDODEV_BIOS_IN_EMPTY_FLUSH			= 169,
    VDODEV_BIOS_IN_PARTIAL_EMPTY_FLUSH		= 170,
    VDODEV_BIOS_IN_PROGRESS_EMPTY_FLUSH		= 171,
    VDODEV_BIOS_JOURNAL_EMPTY_FLUSH		= 172,
    VDODEV_BIOS_JOURNAL_COMPLETED_EMPTY_FLUSH	= 173,
    VDODEV_BIOS_META_EMPTY_FLUSH		= 174,
    VDODEV_BIOS_META_COMPLETED_EMPTY_FLUSH	= 175,
    VDODEV_BIOS_OUT_EMPTY_FLUSH			= 176,
    VDODEV_BIOS_OUT_COMPLETED_EMPTY_FLUSH	= 177,
    VDODEV_BIOS_PAGE_CACHE_EMPTY_FLUSH		= 178,
    VDODEV_BIOS_PAGE_CACHE_COMPLETED_EMPTY_FLUSH = 179,
    VDODEV_HASH_LOCK_CURR_DEDUPE_QUERIES	= 180,
    VDODEV_INDEX_ENTRIES_DISCARDED		= 181,
    /* derived metrics, message backend only (in-tree dm-vdo) */
    VDODEV_WRITE_AMPLIFICATION			= 182,
    VDODEV_EMULATION_512			= 183,
};
