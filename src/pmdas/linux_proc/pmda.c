...
/* proc.id.uid */
  { NULL,
    ...
    PM_TYPE_U32, PROC_INDOM, PM_SEM_DISCRETE, PMDA_PMUNITS(0,0,0,0,0,0)}},
/* proc.id.euid */
  { NULL,
...
/* proc.id.uid_nm */
  { NULL,
    ...
    PM_TYPE_STRING, PROC_INDOM, PM_SEM_DISCRETE, PMDA_PMUNITS(0,0,0,0,0,0)}},
/* proc.id.euid_nm */
  { NULL,
...
/* proc.psinfo.signal_s */
  { NULL,
    ...
    PM_TYPE_STRING, PROC_INDOM, PM_SEM_INSTANT, PMDA_PMUNITS(0,0,0,0,0,0)}},
...
/* proc.memory.vmsize */
  { NULL,
    ...
    PM_TYPE_U32, PROC_INDOM, PM_SEM_INSTANT, PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.memory.vmlock */
  { NULL,
...
/* proc.memory.vmreal */
  { NULL,
    ...
    PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT, PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
...
/* proc.psinfo.threads */
  { NULL,
    ...
    PM_TYPE_U32, PROC_INDOM, PM_SEM_INSTANT, PMDA_PMUNITS(0,0,0,0,0,0)}},
/* proc.psinfo.vctxsw */
  { NULL,
...
/* proc.smaps.rss */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,0), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.pss */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,1), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.pss_anon */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,2), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.pss_file */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,3), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.pss_shmem */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,4), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.shared_clean */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,5), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.shared_dirty */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,6), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.private_clean */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,7), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.private_dirty */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,8), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.referenced */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,9), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.anonymous */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,10), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.lazyfree */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,11), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.anonhugepages */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,12), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.shmempmdmapped */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,13), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.filepmdmapped */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,14), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.shared_hugetlb */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,15), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.private_hugetlb */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,16), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.swap */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,17), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.swappss */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,18), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
/* proc.smaps.locked */
  { NULL,
    { PMDA_PMID(CLUSTER_PID_SMAPS,19), PM_TYPE_U64, PROC_INDOM, PM_SEM_INSTANT,
    PMDA_PMUNITS(1,0,0,PM_SPACE_KBYTE,0,0)}},
...
proc_fetchCallBack(pmdaMetric *mdesc, unsigned int inst, pmAtomValue *atom)
{
	...
	case PROC_PID_SMAPS_RSS: /* proc.smaps.rss */
	    if ((f = _pm_getfield(entry->smaps_lines.rss, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PSS: /* proc.smaps.pss */
	    if ((f = _pm_getfield(entry->smaps_lines.pss, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PSS_ANON: /* proc.smaps.pss_anon */
	    if ((f = _pm_getfield(entry->smaps_lines.pss_anon, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PSS_FILE: /* proc.smaps.pss_file */
	    if ((f = _pm_getfield(entry->smaps_lines.pss_file, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PSS_SHMEM: /* proc.smaps.pss_shmem */
	    if ((f = _pm_getfield(entry->smaps_lines.pss_shmem, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SHARED_CLEAN: /* proc.smaps.shared_clean */
	    if ((f = _pm_getfield(entry->smaps_lines.shared_clean, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SHARED_DIRTY: /* proc.smaps.shared_dirty */
	    if ((f = _pm_getfield(entry->smaps_lines.shared_dirty, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PRIVATE_CLEAN: /* proc.smaps.private_clean */
	    if ((f = _pm_getfield(entry->smaps_lines.private_clean, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PRIVATE_DIRTY: /* proc.smaps.private_dirty */
	    if ((f = _pm_getfield(entry->smaps_lines.private_dirty, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_REFERENCED: /* proc.smaps.referenced */
	    if ((f = _pm_getfield(entry->smaps_lines.referenced, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_ANONYMOUS: /* proc.smaps.anonymous */
	    if ((f = _pm_getfield(entry->smaps_lines.anonymous, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_LAZYFREE: /* proc.smaps.lazyfree */
	    if ((f = _pm_getfield(entry->smaps_lines.lazyfree, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_ANONHUGEPAGES: /* proc.smaps.anonhugepages */
	    if ((f = _pm_getfield(entry->smaps_lines.anonhugepages, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SHMEMPMDMAPPED: /* proc.smaps.shmempmdmapped */
	    if ((f = _pm_getfield(entry->smaps_lines.shmempmdmapped, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_FILEPMDMAPPED: /* proc.smaps.filepmdmapped */
	    if ((f = _pm_getfield(entry->smaps_lines.filepmdmapped, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SHARED_HUGETLB: /* proc.smaps.shared_hugetlb */
	    if ((f = _pm_getfield(entry->smaps_lines.shared_hugetlb, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_PRIVATE_HUGETLB: /* proc.smaps.private_hugetlb */
	    if ((f = _pm_getfield(entry->smaps_lines.private_hugetlb, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SWAP: /* proc.smaps.swap */
	    if ((f = _pm_getfield(entry->smaps_lines.swap, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_SWAPPSS: /* proc.smaps.swappss */
	    if ((f = _pm_getfield(entry->smaps_lines.swappss, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
	case PROC_PID_SMAPS_LOCKED: /* proc.smaps.locked */
	    if ((f = _pm_getfield(entry->smaps_lines.locked, 1)) == NULL)
		return 0;
	    atom->ull = (__uint64_t)strtoull(f, &tail, 0);
	    break;
