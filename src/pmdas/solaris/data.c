...
/* zpool.state */
    { { PMDA_PMID(0,97), PM_TYPE_U64, ZPOOL_INDOM, PM_SEM_DISCRETE,
	PMDA_PMUNITS(0, 0, 0, 0, 0, 0)
      }, M_ZPOOL, VDEV_OFFSET(vs_state) },
/* zpool.state_aux */
    { { PMDA_PMID(0,98), PM_TYPE_U64, ZPOOL_INDOM, PM_SEM_DISCRETE,
	PMDA_PMUNITS(0, 0, 0, 0, 0, 0)
      }, M_ZPOOL, VDEV_OFFSET(vs_aux) },

/* zpool_perdisk.state */
    { { PMDA_PMID(0,99), PM_TYPE_U64, ZPOOL_PERDISK_INDOM, PM_SEM_DISCRETE,
	PMDA_PMUNITS(0, 0, 0, 0, 0, 0)
      }, M_ZPOOL_PERDISK, VDEV_OFFSET(vs_state) },
/* zpool_perdisk.state_aux */
    { { PMDA_PMID(0,100), PM_TYPE_U64, ZPOOL_PERDISK_INDOM, PM_SEM_DISCRETE,
	PMDA_PMUNITS(0, 0, 0, 0, 0, 0)
