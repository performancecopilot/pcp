...
static struct {
    ...
    { .field = "allocstall_dma",
     .offset = &_pm_proc_vmstat.allocstall_dma },
    { .field = "allocstall_dma32",
     .offset = &_pm_proc_vmstat.allocstall_dma32 },
    { .field = "allocstall_high",
     .offset = &_pm_proc_vmstat.allocstall_high },
    { .field = "allocstall_movable",
     .offset = &_pm_proc_vmstat.allocstall_movable },
    { .field = "allocstall_normal",
     .offset = &_pm_proc_vmstat.allocstall_normal },
    ...
    { .field = "compact_daemon_free_scanned",
     .offset = &_pm_proc_vmstat.compact_daemon_free_scanned },
    { .field = "compact_daemon_migrate_scanned",
     .offset = &_pm_proc_vmstat.compact_daemon_migrate_scanned },
    ...
    { .field = "nr_file_hugepages",
     .offset = &_pm_proc_vmstat.nr_file_hugepages },
    { .field = "nr_file_pages",
     .offset = &_pm_proc_vmstat.nr_file_pages },
    { .field = "nr_file_pmdmapped",
     .offset = &_pm_proc_vmstat.nr_file_pmdmapped },
    { .field = "nr_foll_pin_acquired",
     .offset = &_pm_proc_vmstat.nr_foll_pin_acquired },
    { .field = "nr_foll_pin_released",
     .offset = &_pm_proc_vmstat.nr_foll_pin_released },
    { .field = "nr_free_cma",
    ...
    { .field = "nr_kernel_misc_reclaimable",
     .offset = &_pm_proc_vmstat.nr_kernel_misc_reclaimable },
    ...
    { .field = "oom_kill",
     .offset = &_pm_proc_vmstat.oom_kill },
    { .field = "pageoutrun",
    ...
    { .field = "pgsteal_file",
     .offset = &_pm_proc_vmstat.pgsteal_file },
    { .field = "pgsteal_high",
     .offset = &_pm_proc_vmstat.pgsteal_high },
    { .field = "pgsteal_kswapd",
     .offset = &_pm_proc_vmstat.pgsteal_kswapd },
    ...
    { .field = "swap_ra",
     .offset = &_pm_proc_vmstat.swap_ra },
    { .field = "swap_ra_hit",
     .offset = &_pm_proc_vmstat.swap_ra_hit },
    ...
    { .field = "thp_fault_fallback_charge",
     .offset = &_pm_proc_vmstat.thp_fault_fallback_charge },
    ...
    { .field = "thp_split_pud",
     .offset = &_pm_proc_vmstat.thp_split_pud },
    { .field = "thp_swpout",
     .offset = &_pm_proc_vmstat.thp_swpout },
    { .field = "thp_swpout_fallback",
     .offset = &_pm_proc_vmstat.thp_swpout_fallback },
    ...
    { .field = "workingset_nodes",
     .offset = &_pm_proc_vmstat.workingset_nodes },
    { .field = "workingset_refault",
     .offset = &_pm_proc_vmstat.workingset_refault },
    { .field = "workingset_restore",
     .offset = &_pm_proc_vmstat.workingset_restore },
