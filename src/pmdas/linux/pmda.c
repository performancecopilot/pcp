...
/* network.tcp.pawstimewait */
  { &_pm_proc_net_netstat.tcp[_PM_NETSTAT_TCPEXT_PAWSTIMEWAIT],
...
/* network.mptcp.winprobe */
  { &_pm_proc_net_netstat.mptcp[_PM_NETSTAT_MPTCPEXT_WINPROBE],
    { PMDA_PMID(CLUSTER_NET_NETSTAT,240), PM_TYPE_U64, PM_INDOM_NULL, PM_SEM_COUNTER,
    PMDA_PMUNITS(0,0,1,0,0,PM_COUNT_ONE) } },
