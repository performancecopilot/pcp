...
void pmweb_start_daemon (int argc, char **argv)
{
    ...
    if (0 == CreateProcess (NULL, cmdline, NULL, NULL,	/* process and thread attributes */
			    FALSE,	/* inherit handles */
			    CREATE_NEW_PROCESS_GROUP | CREATE_NO_WINDOW | DETACHED_PROCESS, NULL,	/* environment (from parent) */
