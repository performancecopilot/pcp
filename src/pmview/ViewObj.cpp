...
uint_t		ViewObj::theNumModObjects = 0;

ViewObj::~ViewObj()
{
}

ViewObj::ViewObj(uint_t x, uint_t z, uint_t cols, uint_t rows, Alignment align)
...
void
ViewObj::setTran(float xTran, float zTran, uint_t setWidth, uint_t setDepth)
{
...
ostream&
operator<<(ostream& os, ViewObj const& rhs)
{
    rhs.display(os);
    return os;
}
...
void
ViewObj::display(ostream& os) const
{
...
void
ViewObj::dumpShape(ostream& os, ViewObj::Shape shape) const
{
