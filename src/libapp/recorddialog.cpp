...
RecordDialog::RecordDialog() : QDialog()
{
    setupUi(this);
...
void RecordDialog::init(ViewControl *view, double userDelta)
{
...
void PmLogger::init(ViewControl *view, QString host, QString logfile)
{
    my.view = view;
    my.host = host;
    my.logfile = logfile;
