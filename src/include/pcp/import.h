...
PMI_CALL extern pmUnits pmiUnits(int, int, int, unsigned int, unsigned int, unsigned int);
PMI_CALL extern pmUnits pmiExtraUnits(int, int, int, unsigned int, unsigned int, unsigned int, int, unsigned int);
