...
static void
on_key_server_reply(
	keysClusterAsyncContext *c, void *r, void *arg)
{
...
void
on_key_server_client_write(struct client *client)
{
    if (pmDebugOptions.pdu)
...
on_key_server_connected(void *arg)
{
	...
	key_server_discover.callbacks = key_search_search;
    }
