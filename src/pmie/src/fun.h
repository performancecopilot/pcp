...
void cndEq_n_1(Expr *);
void cndEq_1_1(Expr *);
void cndEqStr_n_n(Expr *);
void cndEqStr_1_n(Expr *);
void cndEqStr_n_1(Expr *);
void cndEqStr_1_1(Expr *);
void cndNeq_n_n(Expr *);
void cndNeq_1_n(Expr *);
void cndNeq_n_1(Expr *);
void cndNeq_1_1(Expr *);
void cndNeqStr_n_n(Expr *);
void cndNeqStr_1_n(Expr *);
void cndNeqStr_n_1(Expr *);
void cndNeqStr_1_1(Expr *);
void cndLt_n_n(Expr *);
void cndLt_1_n(Expr *);
void cndLt_n_1(Expr *);
void cndLt_1_1(Expr *);
