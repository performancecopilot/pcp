...
use vars qw( $pmda %cfg %id2metrics %cur_data);
...
%cfg = (
    ...
    # Maximum time in seconds (may also be in fraction) to keep the data for responses
    max_delta_sec => 0.5,
...
sub myredis_fetch {
    ...
    # TODO: Could there be some problem if more than 1 retriever is used
