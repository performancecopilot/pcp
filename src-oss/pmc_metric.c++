...
main(int argc, char* argv[])
{
    ...
    PMC_Metric* hinv_ncpu = group1.addMetric("hinv.ncpu");
    pmflush();
    ...
    PMC_Metric* percpu_user = group1.addMetric("sample.bin");
    pmflush();
    ...
    PMC_Metric* load_avg = group1.addMetric("irix.kernel.all.load[1,5]");
    pmflush();
    ...
    PMC_Metric* sample_hullo = group1.addMetric("sample.string.hullo");
    ...
    PMC_Metric* sample_seconds = group1.addMetric("sample.seconds");
    ...
    PMC_Metric* bogus_metric = group1.addMetric("bogus.metric");
    pmflush();
    ...
    PMC_Metric* bogus_inst = group1.addMetric("irix.kernel.all.load[2]");
    pmflush();
    ...
    PMC_Metric* simple_now = group2.addMetric("simple.now");
    pmflush();
    ...
    PMC_Metric* simple_now2 = group2.addMetric("simple.now");
